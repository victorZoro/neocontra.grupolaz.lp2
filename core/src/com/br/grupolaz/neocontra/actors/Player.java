 ...
 * <h2>Player</h2>
 * <p>
 * a classe Player controla o personagem
 ...
 * </p>
 * <p>
 * -<TextureRegion> actorJumping: Animation
 * </p>
 * 
 * <h3>Métodos</h3>
 * <p>
 * +Player(WorldUtils, Body, TextureRegion)
 * </p>
 * <p>
 * +hit(): void
 * </p>
...
public class Player extends GameActor {
     ...
     * textura que representa a aparência do jogador.
     * </p>
     * 
     ...
     * <h2>hit</h2>
     * <p>
     * A função do método hit() é lidar
    ...
    public void die() {
        JOptionPane.showMessageDialog(null, "FALHEI NA MISSÃO! ASPIRANTE MORTO", "voce perdeu", lifeCount);
        setToDestroy = true;
    }
     ...
     * <h2>setHit</h2>
     * <p>
     * O método setHit(boolean)
     * permite definir o estado de
     * "atingido" do jogador.
     * </p>
     * <p>
     * Ele recebe um valor booleano
     * hit como parâmetro e define esse
     * valor para a variável hit do jogador.
     * </P>
     * 
